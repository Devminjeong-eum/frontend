      ...
      <div className="w-full max-w-[430px] border-1 border-x border-gray-200 shadow-xl">
        <div className="flex flex-col items-center justify-between mt-[30vh] h-[70vh] px-5">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center justify-center gap-3 pt-16">
              <div className="text-lg font-semibold">
                <span className="text-login-navy mr-0.5">개발용어 발음,</span>
                <span>어려우신가요?</span>
              </div>
          ...
          <div className="w-full flex flex-col gap-2 pb-9">
            <button className="relative flex items-center justify-center bg-login-yellow text-base font-semibold rounded-2xl p-4 w-full">
              <div className="absolute left-6">
                <KakaotalkSvg />
              </div>
              <span className="text-center text-login-brown">
                카카오톡으로 시작하기
              </span>
            </button>
            <button
